    ...
    <td valign="top" colspan="3" class="bb">
		...
		<div class="fl" style="width: 99%;">
		 ...
		 <% String email = (String) request.getParameter("email_addr"); 
			 ...
			 Our reply will be sent to your email: <%= StringEscapeUtils.escapeHtml(ServletUtil.sanitizeWeb(email.toLowerCase()))%>
		<% } else {%>
			However, the email you gave is incorrect (<%=StringEscapeUtils.escapeHtml(ServletUtil.sanitizeWeb(email.toLowerCase()))%>) and you will not receive a response.
		<% }%>
		</p>
