...
<div id="wrapper" style="width: 99%;">
    ...
    <td valign="top" colspan="3" class="bb">
		...
		<div class="fl" style="width: 99%;">
		 ...
		 <p>Thank you for your comments<%= StringEscapeUtils.escapeHtml((String)(request.getAttribute("message_feedback")!=null?request.getAttribute("message_feedback"):"")) %>.  They will be reviewed by our Customer Service staff and given the full attention that they deserve. 
