...
**
	...
	public static String transferFunds(String username, long creditActId, long debitActId, double amount) {
	    ...
	    try {
	        ...
	        double updatedDebitBalance = debitAccount.getBalance() + debitAmount;
	        double updatedCreditBalance = creditAccount.getBalance() + creditAmount;
	        statement.execute("UPDATE ACCOUNTS SET BALANCE = " + updatedDebitBalance + " WHERE ACCOUNT_ID = " + debitAccount.getAccountId());
	        statement.execute("UPDATE ACCOUNTS SET BALANCE = " + updatedCreditBalance + " WHERE ACCOUNT_ID = " + creditAccount.getAccountId());
	...
	public static Transaction[] getTransactions(String startDate, String endDate, Account[] accounts, int rowCount) throws SQLException {
		...
		for (Account account : accounts) {
			statement.setInt(parameterIndex, account.getAccountId());
			parameterIndex++;
		}
