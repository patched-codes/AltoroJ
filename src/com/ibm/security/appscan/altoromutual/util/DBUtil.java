...
**
	...
	public static String transferFunds(String username, long creditActId, long debitActId, double amount) {
			...
			try {
				...
				String sqlInsertDebit = "INSERT INTO TRANSACTIONS (ACCOUNTID, DATE, TYPE, AMOUNT) VALUES (?, ?, ?, ?)";
				preparedStatement = connection.prepareStatement(sqlInsertDebit);
				...
				String sqlInsertCredit = "INSERT INTO TRANSACTIONS (ACCOUNTID, DATE, TYPE, AMOUNT) VALUES (?, ?, ?, ?)";
				preparedStatement = connection.prepareStatement(sqlInsertCredit);
				...
				if (debitAccount.getAccountId() == userCC){
					...
					preparedStatement = connection.prepareStatement(sqlInsertFee);
					preparedStatement.setLong(1, debitAccount.getAccountId());
					preparedStatement.setTimestamp(2, date);
				...
				preparedStatement = connection.prepareStatement(sqlUpdateDebit);
				...
				preparedStatement = connection.prepareStatement(sqlUpdateCredit);
